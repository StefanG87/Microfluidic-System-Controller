...
class PlotPanel(QWidget):
    ...
    def _configure_axes(self, draw: bool = True) -> None:
        ...
        self._flow_axis.set_ylabel("Flow [µL/min]", color="#495966")
        self._flow_axis.spines["right"].set_position(("axes", 1.10))
        ...
        self._valve_axis.spines["right"].set_position(("axes", 1.22))
