...
- Plot channel selection is now separated into a dedicated Plot Settings page, grouped by pressure, flow, Fluigent/pressure sensors, and valve/rotary channels, with quick presets for pressure-only, pressure-plus-sensors, all channels, clearing the view, and selecting linear/log scales for time, pressure, and flow/sensor axes.
